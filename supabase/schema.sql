...
-- security_invoker = true ensures queries run under the caller's RLS context,
-- not the view creator's — required by Supabase's security advisor.
CREATE OR REPLACE VIEW vote_summary
